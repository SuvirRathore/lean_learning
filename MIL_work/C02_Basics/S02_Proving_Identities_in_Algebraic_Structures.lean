...
theorem add_left_cancel {a b c : R} (h : a + b = a + c) : b =  c := by
  rw[← add_zero b, ← add_zero c, ← add_neg_cancel a, ← add_assoc, add_comm b, ← add_assoc, add_comm c, h]

theorem add_right_cancel {a b c : R} (h : a + b = c + b) : a = c := by
  rw[add_comm a b, add_comm c b] at h
  rw[← add_zero a, ← add_zero c, ← add_neg_cancel b, ← add_assoc, add_comm a, ← add_assoc, add_comm c, h]
